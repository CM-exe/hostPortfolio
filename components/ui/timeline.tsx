  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto pt-8 px-4 md:px-8 lg:px-10">
        <h2 className="text-2xl md:text-7xl mb-4 text-accent-foreground font-bold font-caption max-w-4xl">
            Timeline
        </h2>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-accent-foreground">
                {item.title}
              </h3>
            </div>
