...
import { BookImage, Code2, FolderCodeIcon, Gamepad2Icon, Map, MapPinned, PlaneTakeoff, TextSearch } from "lucide-react";
...
import { IconBrandNextjs, IconDeviceGamepad2 } from "@tabler/icons-react";
...
export default function Home() {
  ...
  const data = [
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-accent-foreground text-base md:text-xl font-normal">
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-accent-foreground text-base md:text-xl font-normal mb-4">
  ...
  const tabs = [
    {
      ...
      value: "rugby",
      content: (
        <div className="w-full overflow-y-auto no-visible-scrollbar border-b-[30px] border-muted relative h-full rounded-2xl p-10 bg-muted">
    ...
    },
    {
      ...
      value: "coding",
      content: (
        <div className="w-full overflow-y-auto no-visible-scrollbar border-b-[30px] relative h-full rounded-2xl p-10 bg-gradient-to-br from-accent to-muted">
          ...
          <Spacer size="sm" />
          <ul className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-7 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2">
              <GridItem
                ...
                description={
                  <>
                  <Gamepad2Icon size={80} className="text-accent-foreground mx-auto" />
                <p>I like playing video games, often on my console.</p></>
              }
              />
              ...
              <GridItem
                ...
                title="Making project on my own"
                description={
                  <>
                  <FolderCodeIcon size={80} className="text-accent-foreground mx-auto" />
                <p>I like making project on my own, like this portfolio.</p></>
              }
              />
              ...
              <GridItem
                ...
                description={
                  <>
                  <IconBrandNextjs size={120} className="text-accent-foreground mx-auto" />
                <p>I like learning new technologies, this portfolio helped me to learn Nextjs and grow skills.</p></>
              }
              />
            </ul>
            <Spacer size="xs" />
